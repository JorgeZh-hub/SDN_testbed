...
#
#   Usage:
#     ./capture_link_metrics.sh "sw1-if1, sw2-if2, cap_mbps" [...] -o dir -i 1 [--queue-analyzer]
#
#   Example:
#     ./capture_link_metrics.sh \
#       "switch14-eth1, switch15-eth2, 30" \
#       "switch1-eth1, switch5-eth2, 50" \
#       -o ./link_metrics -i 1 --queue-analyzer
#
...
if [ ${#LINKS[@]} -eq 0 ]; then
    ...
    echo "Example: $0 switch14-eth1-switch15-eth2 -o ./link_metrics -i 1"
    exit 1
fi
